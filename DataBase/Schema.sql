...
\restrict QlNySvACq0pubEdPbfCPe2h1gfHZ9RqfXXUc1lHP7MolproSFk4iiOiXfYTfN8v

-- Dumped from database version 16.13 (Ubuntu 16.13-0ubuntu0.24.04.1)
-- Dumped by pg_dump version 18.1

-- Started on 2026-03-08 14:08:18
...
-- Name: factory_factory_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.factory ALTER COLUMN factory_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.factory_factory_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: part_measurement_part_measurement_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.part_measurement ALTER COLUMN part_measurement_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.part_measurement_part_measurement_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 239 (class 1259 OID 16720)
-- Name: part_measurement_spec_part_measurement_spec_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.part_measurement_spec ALTER COLUMN part_measurement_spec_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.part_measurement_spec_part_measurement_spec_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: part_part_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.part ALTER COLUMN part_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.part_part_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 240 (class 1259 OID 16721)
-- Name: part_tracking_attribute_part_tracking_attribute_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.part_tracking_attribute ALTER COLUMN part_tracking_attribute_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.part_tracking_attribute_part_tracking_attribute_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: part_workstation_requirement_part_workstation_requirement_i_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.part_workstation_requirement ALTER COLUMN part_workstation_requirement_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.part_workstation_requirement_part_workstation_requirement_i_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: reject_code_reject_code_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.reject_code ALTER COLUMN reject_code_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.reject_code_reject_code_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 244 (class 1259 OID 16725)
-- Name: workstation_type_workstation_type_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.workstation_type ALTER COLUMN workstation_type_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.workstation_type_workstation_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: workstation_workstation_id_seq; Type: SEQUENCE; Schema: core; Owner: LouNexus_Admin
--

ALTER TABLE core.workstation ALTER COLUMN workstation_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME core.workstation_workstation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: raw_material_raw_material_id_seq; Type: SEQUENCE; Schema: inventory; Owner: LouNexus_Admin
--

ALTER TABLE inventory.raw_material ALTER COLUMN raw_material_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME inventory.raw_material_raw_material_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: inspection_inspection_id_seq; Type: SEQUENCE; Schema: prod; Owner: LouNexus_Admin
--

ALTER TABLE prod.inspection ALTER COLUMN inspection_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME prod.inspection_inspection_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: station_event_attribute_station_event_attribute_id_seq; Type: SEQUENCE; Schema: prod; Owner: LouNexus_Admin
--

ALTER TABLE prod.station_event_attribute ALTER COLUMN station_event_attribute_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME prod.station_event_attribute_station_event_attribute_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 249 (class 1259 OID 16730)
-- Name: station_event_reject_station_event_reject_id_seq; Type: SEQUENCE; Schema: prod; Owner: LouNexus_Admin
--

ALTER TABLE prod.station_event_reject ALTER COLUMN station_event_reject_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME prod.station_event_reject_station_event_reject_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: station_event_station_event_id_seq; Type: SEQUENCE; Schema: prod; Owner: LouNexus_Admin
--

ALTER TABLE prod.station_event ALTER COLUMN station_event_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME prod.station_event_station_event_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 250 (class 1259 OID 16731)
-- Name: measurement_set_measurement_set_id_seq; Type: SEQUENCE; Schema: quality; Owner: LouNexus_Admin
--

ALTER TABLE quality.measurement_set ALTER COLUMN measurement_set_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME quality.measurement_set_measurement_set_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 251 (class 1259 OID 16732)
-- Name: measurement_value_measurement_value_id_seq; Type: SEQUENCE; Schema: quality; Owner: LouNexus_Admin
--

ALTER TABLE quality.measurement_value ALTER COLUMN measurement_value_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME quality.measurement_value_measurement_value_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 3376 (class 2606 OID 16406)
...
--
-- TOC entry 3408 (class 2606 OID 16551)
...
--
-- TOC entry 3406 (class 2606 OID 16523)
...
--
-- TOC entry 3404 (class 2606 OID 16509)
...
--
-- TOC entry 3390 (class 2606 OID 16452)
...
--
-- TOC entry 3396 (class 2606 OID 16461)
...
--
-- TOC entry 3386 (class 2606 OID 16440)
...
--
-- TOC entry 3388 (class 2606 OID 16442)
...
--
-- TOC entry 3380 (class 2606 OID 16426)
...
--
-- TOC entry 3392 (class 2606 OID 16454)
...
--
-- TOC entry 3394 (class 2606 OID 16456)
...
--
-- TOC entry 3382 (class 2606 OID 16424)
...
--
-- TOC entry 3398 (class 2606 OID 16484)
...
--
-- TOC entry 3400 (class 2606 OID 16488)
...
--
-- TOC entry 3436 (class 2606 OID 16706)
...
--
-- TOC entry 3412 (class 2606 OID 16561)
...
--
-- TOC entry 3424 (class 2606 OID 16627)
...
--
-- TOC entry 3426 (class 2606 OID 16625)
...
--
-- TOC entry 3416 (class 2606 OID 16582)
...
--
-- TOC entry 3418 (class 2606 OID 16600)
...
--
-- TOC entry 3414 (class 2606 OID 16563)
...
--
-- TOC entry 3422 (class 2606 OID 16612)
...
--
-- TOC entry 3428 (class 2606 OID 16648)
...
--
-- TOC entry 3432 (class 2606 OID 16678)
...
ALTER TABLE ONLY quality.measurement_set
    ADD CONSTRAINT "no dupes" UNIQUE (station_event_id, "part_measurement_Spec_id");


--
-- TOC entry 3434 (class 2606 OID 16680)
...
--
-- TOC entry 3437 (class 2606 OID 16427)
...
--
-- TOC entry 3439 (class 2606 OID 16462)
...
--
-- TOC entry 3441 (class 2606 OID 16510)
...
--
-- TOC entry 3442 (class 2606 OID 16524)
...
--
-- TOC entry 3443 (class 2606 OID 16540)
...
--
-- TOC entry 3444 (class 2606 OID 16545)
...
--
-- TOC entry 3438 (class 2606 OID 16489)
...
--
-- TOC entry 3456 (class 2606 OID 16712)
...
--
-- TOC entry 3457 (class 2606 OID 16707)
...
--
-- TOC entry 3447 (class 2606 OID 16583)
...
--
-- TOC entry 3451 (class 2606 OID 16633)
...
--
-- TOC entry 3449 (class 2606 OID 16601)
...
--
-- TOC entry 3452 (class 2606 OID 16628)
...
--
-- TOC entry 3450 (class 2606 OID 16606)
...
--
-- TOC entry 3448 (class 2606 OID 16588)
...
--
-- TOC entry 3453 (class 2606 OID 16656)
-- Name: measurement_set part measurement id fk; Type: FK CONSTRAINT; Schema: quality; Owner: LouNexus_Admin
--

ALTER TABLE ONLY quality.measurement_set
    ADD CONSTRAINT "part measurement id fk" FOREIGN KEY ("part_measurement_Spec_id") REFERENCES core.part_measurement(part_measurement_id);
...
--
-- TOC entry 2122 (class 826 OID 16692)
...
--
-- TOC entry 2123 (class 826 OID 16693)
...
--
-- TOC entry 2121 (class 826 OID 16691)
...
--
-- TOC entry 2118 (class 826 OID 16397)
...
--
-- TOC entry 2124 (class 826 OID 16695)
...
--
-- TOC entry 2119 (class 826 OID 16552)
...
--
-- TOC entry 2120 (class 826 OID 16640)
...
-- Completed on 2026-03-08 14:08:18

--
-- PostgreSQL database dump complete
--

\unrestrict QlNySvACq0pubEdPbfCPe2h1gfHZ9RqfXXUc1lHP7MolproSFk4iiOiXfYTfN8v
